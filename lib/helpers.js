...
export const imagekitUrl = (sourceurl, query='') => {
    const fileNameWithAccessQuery = String(sourceurl).split('appspot.com')[1]
    return `https://ik.imagekit.io/forde${fileNameWithAccessQuery}${query ? '&'+query : ''}`
    //https://ik.imagekit.io/tdt9enhsj/o/uploads%2FiFkk7KatxLS3BHkZdaZlc66wOOr1%2F1651833391313.jpeg?alt=media&token=ad81e11f-b436-483f-b353-923090195f98&tr=w-300
//https://firebasestorage.googleapis.com/v0/b/makro-1431c.appspot.com/o/uploads%2F86HXeSnmzHYCuthsh6XNFt32E5Y2%2F1621548425201.jpeg?alt=media&token=550dba27-82e1-4596-aaab-89eeaf891509
}